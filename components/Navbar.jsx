    ...
    <div>
      <nav className=" py-10 mb-12 flex justify-between">
        ...
        <ul className="flex items-center">
          ...
          <li>
            <a
              href="/Hoa_Nguyen_Resume.pdf"
              className="bg-gradient-to-r from-green-500 to-emerald-500 text-gray-100 px-4 py-2 rounded-md ml-8 hover:to-green-500 hover:from-emerald-500 duration-500"
              target="_blank"
            >
              resume
            </a>
